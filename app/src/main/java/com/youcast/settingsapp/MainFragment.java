package com.youcast.settingsapp;
...
public class MainFragment extends BrowseSupportFragment {
    ...
    private void loadRows() {
        ...
        ArrayObjectAdapter rowsAdapter = new ArrayObjectAdapter(presenter);

        HeaderItem gridHeader = new HeaderItem(0, getString(R.string.preference));

        GridItemPresenter mGridPresenter = new GridItemPresenter();
        ArrayObjectAdapter gridRowAdapter = new ArrayObjectAdapter(mGridPresenter);

        gridRowAdapter.add(getResources().getString(R.string.apps));
